...
public final class DefaultFindCheckBuilderWrapper {
  ...
  public DefaultFindCheckBuilderWrapper(
      DefaultFindCheckBuilder<HttpCheck, Response, Integer> status) {
  ...
  public CheckBuilderWrapper<HttpCheck, Response, Integer> is(
      Function<Session, Integer> expression) {
