 ...
 */
public final class WsSendBinaryFrameBuilderWrapper implements Supplier<WsSendBinaryFrameBuilder>, ActionBuilderSupplier {
...
//    public WsSendBinaryFrameBuilderWrapper check(CheckBuilder<AsyncCheck, String, ?, ?> checkBuilder) {
//        return new WsSendBinaryFrameBuilderWrapper(get().check(checkBuilder));
//    }
//
//    public WsSendBinaryFrameBuilderWrapper check(AsyncPlainCheckBuilderWrapper asyncPlainCheckBuilderWrapper) {
